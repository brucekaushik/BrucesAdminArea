...
<div class="container">
    ...
    <div class="formscontainer">
        ...
        <div style="color: red; font-weight:bold;" class='centeralign'><br><br>Use the form below to DELETE the admin selected.</div><br><br>
		
        <form action="home.php?action=deleteAdminSubmission" method="post">
            ...
            <input type="hidden" name="level" value="admin"><br>
            <center><br><input type="submit" value="delete" style="width: 100px"></center>
